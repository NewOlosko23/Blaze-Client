import { ChefHat, DollarSign, Flame, House, Leaf, ArrowRight, CheckCircle, Star, Users, Zap } from 'lucide-react';
import { Link } from 'react-router-dom';
import BackToTop from '../components/BackToTop';
import SEO from '../components/SEO';
import { localBusinessSchema, organizationSchema, productSchema } from '../data/structuredData';
  ...
  return (
    <div className="overflow-x-hidden">
      <SEO 
        ...
        structuredData={[localBusinessSchema, organizationSchema, productSchema]}
      />
      {/* Modern Hero Section */}
      <section 
      ...
      >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="inline-flex items-center px-4 mt-5 py-2 rounded-full bg-green-100 text-green-800 text-sm font-medium">
                ...
                Trusted by 800+ customers
                  ...
                  <div className="space-y-4">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight" itemProp="name">
                      Premium{' '}
                    ...
                    <p className="text-lg sm:text-xl text-gray-200 leading-relaxed max-w-2xl">
                      High-quality charcoal briquettes for cooking, heating, and grilling. 
                      Long-lasting, efficient, and perfect for your home or business needs.
                    </p>
                  </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link 
                      to="/order"
                      className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors duration-200 shadow-lg hover:shadow-xl text-sm sm:text-base"
                    >
                      Order Now
              ...
              <div className="flex items-center space-x-6 pt-4">
                <div className="flex items-center space-x-2">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-r from-green-400 to-green-600 border-2 border-white"></div>
                    ))}
                  </div>
            ...
            <div className="relative">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Premium Charcoal Briquettes</h3>
                        <p className="text-sm text-gray-500">High-Quality Fuel</p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="text-2xl font-bold text-gray-900">4-6 hrs</div>
                      <div className="text-sm text-gray-500">Burn Time</div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="text-2xl font-bold text-gray-900">20kg</div>
              ...
              <div className="absolute -top-4 -right-4 bg-white rounded-xl shadow-lg p-4 border border-gray-100">
                ...
                <div className="text-2xl font-bold text-green-600 mt-1">500+</div>
              </div>
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 opacity-20">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-orange-500 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
          </div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Experience the difference with charcoal briquettes engineered for cooking and heating. 
              Not just fuel – it's the foundation of perfect fire.
            </p>
          </div>
          ...
          <div className="space-y-16">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-3xl font-bold text-white">Consistent Heat</h3>
                      <p className="text-red-400 font-semibold">4-6 Hours of Perfect Fire</p>
                    </div>
                  </div>
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Our briquettes maintain steady temperature throughout your entire cooking session. 
                    No more adjusting vents or adding fuel mid-cook.
                  </p>
                  <div className="flex items-center space-x-8">
                        <div className="text-center">
                          <div className="text-3xl font-bold text-red-500">450°C</div>
                          <div className="text-sm text-gray-400">Peak Temperature</div>
                        </div>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-orange-500">4-6h</div>
                      <div className="text-sm text-gray-400">Burn Duration</div>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-yellow-500">95%</div>
                      <div className="text-sm text-gray-400">Heat Retention</div>
                    </div>
                  </div>
                </div>
                <div className="relative">
                  <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 border border-gray-700 shadow-2xl">
                    <div className="text-center mb-6">
                      <div className="text-4xl font-bold text-white mb-2">Heat Curve</div>
                    ...
                    <div className="relative h-32 bg-gray-900 rounded-lg p-4">
                      <div className="absolute inset-4">
                        <div className="w-full h-full bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-lg flex items-end">
                          ...
                          <div className="absolute top-2 left-4 text-xs text-gray-400">450°C</div>
                      <div className="absolute bottom-2 left-4 text-xs text-gray-400">0h</div>
                      <div className="absolute bottom-2 right-4 text-xs text-gray-400">6h</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="relative order-2 lg:order-1">
                  <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 border border-gray-700 shadow-2xl">
                    <div className="text-center mb-6">
                      <div className="text-4xl font-bold text-white mb-2">Ash Comparison</div>
                      <div className="text-gray-400">Traditional vs Blaze Briquettes</div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-gray-900 rounded-lg">
                        <span className="text-white font-semibold">Traditional Charcoal</span>
                        <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-900 rounded-lg">
                        <span className="text-white font-semibold">Blaze Briquettes</span>
                        <div className="flex items-center space-x-2">
                          <div className="w-24 h-4 bg-gray-600 rounded-full">
                ...
                <div className="space-y-6 order-1 lg:order-2">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-3xl font-bold text-white">Minimal Ash</h3>
                      <p className="text-green-400 font-semibold">90% Less Cleanup</p>
                    </div>
                  </div>
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Clean burning technology means less mess, easier cleanup, and better air quality 
                    for your cooking environment.
                  </p>
                  <div className="grid grid-cols-2 gap-4">
            ...
            <div className="relative">
              <div className="text-center mb-12">
                <h3 className="text-4xl font-bold text-white mb-4">Perfect for Every Fire</h3>
                <p className="text-xl text-gray-300">From backyard grilling to industrial heating</p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700 hover:border-orange-500 transition-colors duration-300">
                  <div className="text-center">
                    ...
                    <h4 className="text-xl font-bold text-white mb-2">Grilling</h4>
                    <p className="text-gray-400 text-sm">Perfect sear marks, even cooking</p>
                  </div>
                </div>
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700 hover:border-blue-500 transition-colors duration-300">
                  <div className="text-center">
                    ...
                    <h4 className="text-xl font-bold text-white mb-2">Heating</h4>
                    <p className="text-gray-400 text-sm">Long-lasting warmth for any space</p>
                  </div>
                </div>
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700 hover:border-purple-500 transition-colors duration-300">
                  <div className="text-center">
                    ...
                    <h4 className="text-xl font-bold text-white mb-2">Smoking</h4>
                    <p className="text-gray-400 text-sm">Low, slow, and consistent</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Quality charcoal briquettes at unbeatable prices. No hidden fees, no surprises.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-6 sm:p-8 border border-gray-700 hover:border-green-500 transition-all duration-300 transform hover:-translate-y-2">
              <div className="text-center">
                ...
                <div className="mb-6">
                  <span className="text-5xl font-bold text-green-400">KSh 200</span>
                  <span className="text-gray-300 text-lg">/kg</span>
                </div>
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                    <span>1kg of premium briquettes</span>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                    <span>4-6 hours burn time</span>
                  </li>
                      <li className="flex items-center text-gray-300">
                        <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                ...
                <Link 
                  to="/order"
                  className="w-full bg-green-600 text-white py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors duration-200 shadow-lg hover:shadow-xl inline-block text-center"
                >
                  Order Now
                </Link>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 border-2 border-green-500 relative hover:border-green-400 transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Bulk Purchase</h3>
                <div className="mb-6">
                  <span className="text-5xl font-bold text-green-400">KSh 1,800</span>
                  <span className="text-gray-300 text-lg">/10kg</span>
                  <div className="text-sm text-green-400 font-semibold mt-2">Save KSh 200</div>
                </div>
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                    <span>10kg of premium briquettes</span>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                    <span>40-60 hours total burn time</span>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-6 sm:p-8 border border-gray-700 hover:border-green-500 transition-all duration-300 transform hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Wholesale</h3>
                <div className="mb-6">
                  <span className="text-5xl font-bold text-green-400">KSh 3,500</span>
                  <span className="text-gray-300 text-lg">/20kg</span>
                  <div className="text-sm text-green-400 font-semibold mt-2">Save KSh 500</div>
                </div>
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                    <span>20kg of premium briquettes</span>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                    <span>80-120 hours total burn time</span>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                    <span>Delivery from KSh 300</span>
                  ...
                  <li className="flex items-center text-gray-300">
                    ...
                    <button 
                      ...
                      className="w-full bg-green-600 text-white py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
                    >
          ...
          <div className="text-center mt-12">
            <p className="text-gray-300 mb-4">Delivery charges start from KSh 300</p>
      ...
      <section className="py-20 bg-gradient-to-br from-green-900 to-green-800 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-green-100 max-w-4xl mx-auto">
              Our charcoal briquettes are made from 100% recycled materials, reducing waste 
              and contributing to Kenya's environmental sustainability goals.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                <h3 className="text-2xl font-bold text-white mb-4">Environmental Benefits</h3>
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="text-white font-semibold">Waste Reduction</div>
                      <div className="text-green-200 text-sm">Diverts 2,000+ tons of waste annually</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="text-white font-semibold">Carbon Footprint</div>
                      <div className="text-green-200 text-sm">75% lower emissions than traditional charcoal</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="text-white font-semibold">Sustainable Production</div>
                      <div className="text-green-200 text-sm">100% recycled agricultural waste</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-white text-sm">Tons Waste Diverted</div>
                  </div>
                  <div className="text-center">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 opacity-20">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-red-500 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
          </div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Hear from our customers who've experienced the difference with Blaze Briquettes. 
              These aren't just reviews – they're fire stories.
            </p>
          </div>
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-6 sm:p-8 border border-gray-700 hover:border-orange-500 transition-all duration-300 transform hover:-translate-y-2">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-sm">Restaurant Owner, Nairobi</div>
                ...
                <blockquote className="text-gray-300 text-lg leading-relaxed mb-6">
                  "These briquettes transformed my restaurant's cooking. Consistent heat for 6+ hours, 
                  perfect sear marks on every steak. My customers can taste the difference."
                </blockquote>
                <div className="flex items-center justify-between">
                  <div className="text-orange-400 font-semibold">6 months customer</div>
                  <div className="text-gray-500 text-sm">Orders 50kg monthly</div>
                </div>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 border border-gray-700 hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-2">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <div className="text-white font-bold text-lg">Alice Wanjiku</div>
                    <div className="text-gray-400 text-sm">Home Chef, Mombasa</div>
                    <div className="flex text-yellow-400 mt-1">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className="w-4 h-4 fill-current" />
                      ))}
                ...
                <blockquote className="text-gray-300 text-lg leading-relaxed mb-6">
                  "The environmental impact sold me. Made from recycled materials, burns clean, 
                  minimal ash. I feel good about my cooking choices now."
                </blockquote>
                <div className="flex items-center justify-between">
                  <div className="text-blue-400 font-semibold">Environmental advocate</div>
            ...
            <div className="group relative">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 border border-gray-700 hover:border-purple-500 transition-all duration-300 transform hover:-translate-y-2">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <div className="text-white font-bold text-lg">Peter Kimani</div>
                    <div className="text-gray-400 text-sm">BBQ Enthusiast, Kisumu</div>
                    <div className="flex text-yellow-400 mt-1">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className="w-4 h-4 fill-current" />
                      ))}
                ...
                <blockquote className="text-gray-300 text-lg leading-relaxed mb-6">
                  ...
                  My brisket has never been better. The neighbors ask for my secret."
                </blockquote>
                <div className="flex items-center justify-between">
                  <div className="text-purple-400 font-semibold">Smoking expert</div>
          ...
          <div className="mt-16 bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                <div className="text-4xl font-bold text-blue-500 mb-2">2,847</div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Contact us today for orders, delivery inquiries, or any questions about our 
              premium charcoal briquettes. We're here to fuel your fire.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-gray-900 rounded-xl hover:bg-gray-800 transition-colors duration-200">
                    ...
                    <div>
                      ...
                      <div className="text-gray-300">info@blazebriquettes.co.ke</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4 p-4 bg-gray-900 rounded-xl hover:bg-gray-800 transition-colors duration-200">
                    <div className="w-12 h-12 bg-green-600 rounded-xl flex items-center justify-center">
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-gray-900 rounded-xl hover:bg-gray-800 transition-colors duration-200">
                    ...
                    <div>
                      ...
                      <div className="text-gray-300">Countrywide delivery available</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-6 sm:p-8 shadow-xl border border-gray-700">
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <select className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-700 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
            Join thousands of satisfied customers who have made the switch to Blaze Briquettes. 
            Order now and experience the difference.
          </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  to="/order"
                  className="bg-white text-green-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors duration-200 shadow-lg hover:shadow-xl inline-block text-center"
                >
                  Order Now - KSh 200/kg
                </Link>
                <a 
                  href="tel:+254715607720"
                  className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-green-600 transition-colors duration-200 inline-block text-center"
                >
